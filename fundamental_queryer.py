...
+ "IMPORTANT: 如果你获得了 `fixture_id`，请务必先调用 `get_fixture_basic_info(fixture_id)` 来获取 `home_id`, `away_id`, `league_id`, 和 `season`。你需要这些参数来调用其他工具，如 `get_standing_home_info`, `get_home_last_10` 等。"
+ "请使用以下可用工具: "
